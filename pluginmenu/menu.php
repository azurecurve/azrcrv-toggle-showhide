 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_tsh')){
	function azrcrv_create_plugin_menu_tsh(){
		azrcrv_create_plugin_menu_table_tsh();
		azrcrv_populate_plugin_menu_table_tsh();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_tsh')){
	function azrcrv_populate_plugin_menu_table_tsh(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_tsh')){
	function azrcrv_create_plugin_menu_table_tsh(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
